...
const baseTips = [
  ...
  { icon: <Gauge className="w-5 h-5" />, title: 'Use Battery Saver', desc: 'Windows Battery Saver mode reduces background activity and extends runtime when you\'re on battery.', pro: 'Set it to activate at 30% remaining.' },
  ...
  { icon: <Plug className="w-5 h-5" />, title: 'Don\'t Stay Plugged In', desc: 'Constant 100% charge creates trickle-charge stress. Unplug when full or use a charge limiter.', pro: 'Use manufacturer tools like Lenovo Conservation Mode.' },
  ...
  { icon: <Zap className="w-5 h-5" />, title: 'Avoid Rapid Charging', desc: 'Fast charging generates more heat and stress. Use standard charging when you\'re not in a hurry.', pro: 'Standard 65W is gentler than 100W+ chargers.' },
