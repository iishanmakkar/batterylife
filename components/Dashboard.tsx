        ...
        <div className="space-y-5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            <div className="bg-[var(--color-bg2)] border border-[var(--color-border)] rounded-2xl p-4">
              ...
              <div className="font-[family-name:var(--font-mono)] text-lg text-[var(--color-text1)] font-bold">{resale.label}</div>
            ...
            <div className="bg-[var(--color-bg2)] border border-[var(--color-border)] rounded-2xl p-4">
              ...
              <div className="font-[family-name:var(--font-mono)] text-lg text-[var(--color-text1)] font-bold">{gaming.level}</div>
            ...
            <div className="bg-[var(--color-bg2)] border border-[var(--color-border)] rounded-2xl p-4">
              ...
              <div className="font-[family-name:var(--font-mono)] text-lg text-[var(--color-text1)] font-bold">{health.estimatedLifespan}</div>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                {[
                  ...
                  <div key={i}>
                    ...
                    <div className="font-[family-name:var(--font-mono)] text-lg font-bold text-[var(--color-text1)]">{m.v}</div>
                  </div>
                ))}
              </div>
            </div>
                    ...
                    <tbody>
                      {report.drainSessions.map((s, i) => (
                        <tr key={i} className="border-t border-[var(--color-border)] hover:bg-[var(--color-bg3)] transition-colors">
                          <td className="py-2.5 px-4 font-[family-name:var(--font-mono)] text-[var(--color-text1)]">{s.date.slice(0, 16)}</td>
                          ...
                          <td className="py-2.5 px-4">
                            <div className="flex items-center gap-2">
                              ...
                              <span className="font-[family-name:var(--font-mono)] text-[var(--color-text1)]">{s.drain}%</span>
                            </div>
                          </td>
                          <td className="py-2.5 px-4 font-[family-name:var(--font-mono)] text-[var(--color-text2)]">{s.mwh} mWh</td>
                          <td className="py-2.5 px-4 font-[family-name:var(--font-mono)] text-[var(--color-text2)]">{s.rate} mWh/h</td>
                          <td className="py-2.5 px-4">
